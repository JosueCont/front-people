...
const initialData = {
    ...
    load_perceptions_int: false,
    load_deductions_int: false,
    load_other_payments_int: false
};
...
const webReducer = (state = initialData, action) => {
    switch (action.type) {
        ...
        case PERCEPTIONS_INT:
            return {
                ...state,
                perceptions_int: action.payload,
                load_perceptions_int: action.fetching
            };
        case DEDUCTIONS_INT:
            return {
                ...state,
                deductions_int: action.payload,
                load_deductions_int: action.fetching
            };
        case OTHER_PAYMENTS_INT:
            return {
                ...state,
                other_payments_int: action.payload,
                load_other_payments_int: action.fetching
            };
        case TYPE_TAX:
...
export const getInternalPerceptions = (data, versionCfdi) => async (dispatch, getState) => {
    const action = { type: PERCEPTIONS_INT, payload: [], fetching: false };
...
export const getInternalDeductions = (data, versionCfdi) => async (dispatch, getState) => {
    const action = { type: DEDUCTIONS_INT, payload: [], fetching: false };
    dispatch({ ...action, fetching: true })
    try {
...
export const getInternalOtherPayments = (data) => async (dispatch, getState) => {
    const action = {type: OTHER_PAYMENTS_INT, payload: [], fetching: false}
    dispatch({...action, fetching: true})
    try {
