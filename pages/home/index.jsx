...
const homeScreen = () => {
    ...
    const AlertDeletes = () => (
        <div>
            Al eliminar este registro perderá todos los datos relacionados a el de manera permanente. ¿Está seguro de querer eliminarlo
            <br />
            <br />
                            ...
                            <Row gutter={[24, 8]}>
                                <Col>
                                    <Form.Item name="name" label={'Nombre, apellido'}>
                                        <Input allowClear={true} placeholder="Nombre, Apellido" style={{ width: 150 }} />
                                    </Form.Item>
                                </Col>
                                <Col>
                                ...
                                <Col>
                                    <Form.Item name="job" label="Puesto">
                                        <Select options={jobs} placeholder="Todos" style={{ minWidth: 100 }} />
                                    </Form.Item>
                                </Col>
                                <Col>
                                    <Form.Item name="is_active" label="Estatus">
                                        <Select options={statusSelect} placeholder="" style={{ width: 90 }} />
                                    </Form.Item>
                                </Col>
