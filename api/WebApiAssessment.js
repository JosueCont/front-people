...
class WebApiAssessment {
  ...
  static orderSection(type, data) {
    return Axios.post(`${urlKuizBaseApiWithTenant}/assessments/section/${type}/`, data);
  }
  ...
  static orderQuestion(type, data) {
    return Axios.post(`${urlKuizBaseApiWithTenant}/assessments/question/${type}/`, data);
  }
  ...
  static orderAnswer(type, data) {
    return Axios.post(`${urlKuizBaseApiWithTenant}/assessments/answer/${type}/`, data);
  }
