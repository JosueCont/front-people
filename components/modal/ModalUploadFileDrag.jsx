...
const ModalUploadFileDrag = ({
  ...
  return (
    ...
    >
      <Row>
        <Col span={24}>
          <Dragger {..._props} style={{}}>
            {upload.length > 0 ? (
              <>
                <FileTextOutlined style={{ fontSize: 50 }} />
                {upload.length > 0 && (
                  <Title level={2}>{upload.length} elementos</Title>
                )}
              </>
            ) : (
              <>
                ...
                <p className="ant-upload-hint">
                  ...
                  archivos xml de recibos de nómina ó archivos .zip que
                  contengan elementos xmls. En caso de elegir archivos
                  comprimidos considerar que dentro sólo debe contener carpetas
                  y xmls.
                </p>
              </>
            )}
