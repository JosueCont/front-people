        ...
        <Row gutter={[24, 0]}>
            ...
            <Col span={24}>
                <Row gutter={[24, 24]}>
                    <Col xs={24} xl={12}>
                        <EditorHTML
                            label='¿Para que actividades lo utiliza?'
                            placeholder='Especificar según los idiomas seleccionados'
                            textHTML={infoVacant?.education_and_competence?.language_activities}
                    ...
                    <Col xs={24} xl={12}>
                        <EditorHTML
                            ...
                            textHTML={infoVacant?.education_and_competence?.knowledge}
                    ...
                    <Col xs={24} xl={12}>
                        <EditorHTML
                            ...
                            placeholder='Especificar la experiencia'
                            textHTML={infoVacant?.education_and_competence?.experience}
                    ...
                    <Col xs={24} xl={12}>
                        <EditorHTML
                            ...
                            placeholder='Especificar las habilidades'
                            textHTML={infoVacant?.education_and_competence?.technical_skills?.at(-1)}
