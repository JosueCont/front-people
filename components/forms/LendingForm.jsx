        ...
        <Form form={form} layout="horizontal" onFinish={props.onFinish}>
            <Row justify={"start"}>
                ...
                <Col span="8">
                    ...
                    >
                        <InputNumber
                            max={props.config ? parseInt(props.config.max_amount) : null}
                            min={props.config ? parseInt(props.config.min_amount) : null}
                            onChange={getPayment}
                            style={{ width: "100%" }}
                            formatter={(value) =>
                    ...
                    >
                        ...
                        max={props.config ? parseInt(props.config.max_deadline) : null}
                        min={props.config ? parseInt(props.config.min_deadline) : null}
                        />
