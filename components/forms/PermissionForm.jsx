        ...
        <Row>
            ...
            <Col span="8" offset={1}>
                <Form.Item name="departure_date" label="Fecha de salida" labelCol={{ span: 9 }} labelAlign={'left'}>
                    <DatePicker disabled={props.readOnly} key="departure_date"  style={{ width:'100%' }} onChange={props.onChangeDepartureDate} />
                </Form.Item>
                <Form.Item name="return_date" label="Fecha de regreso" labelCol={{ span: 9 }} labelAlign={'left'}>
                    <DatePicker disabled={props.readOnly} key="return_date"  style={{ width:'100%' }} onChange={props.onChangeReturnDate} />
                </Form.Item>
            </Col>
