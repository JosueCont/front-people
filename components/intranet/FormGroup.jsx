...
const FormGroup = (props) => {
    ...
    const saveGroup = (data) => {
        ...
        if (props.isEdit) {
            axios.put(API_URL +`/intranet/group/${props.group.id}/`, params).then(res => {
                console.log("saveGrop", res)
                closeDialog()
            }).catch(e => {
                console.log("error", e)
                closeDialog()
        ...
        axios.post(API_URL + "/intranet/group/", params).then(res => {
            console.log("saveGrop", res)
            closeDialog()
        }).catch(e => {
            console.log("error", e)
            ...
            <Layout>
                ...
                >
                    <Form onFinish={onFinish} form={forms}>
                        ...
                        <Form.Item label="Nombre de grupo" name="name" rules={[ruleRequired]} labelAlign={"left"}>
                            <Input type="text"/>
                        </Form.Item>


                        <Form.Item label="Descripción de grupo" name="description"
                                   labelAlign={"left"}>
                            <Input.TextArea/>
                        </Form.Item>
