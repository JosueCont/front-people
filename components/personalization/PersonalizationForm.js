...
const PersonalizationForm=(props)=>{
    ...
    const [icon, setIcon] = useState(props.getIcon ? props.getIcon+"?"+new Date():null);
    ...
    const saveConfig = (data) => {
        let jsoForm={
            ...
            concierge_secondary_color:data.secondaryColor ? data.secondaryColor : "#000",
        }

        console.log("parametro:::", jsoForm)
