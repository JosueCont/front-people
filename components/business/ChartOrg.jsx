...
const ChartOrg = ({mainLogo, nodes, ...props}) => {
    let chart;

    /* Empresa principal */
    OrgChart.templates.mainCompany = Object.assign({}, OrgChart.templates.ana);
    OrgChart.templates.mainCompany.size = [200, 200];
    OrgChart.templates.mainCompany.img_0 = '<image xlink:href="{val}"  y="21"  width="200" height="100"></image>';
    OrgChart.templates.mainCompany.node = '<rect  height="200" width="{w}" fill="#f9f9f9" stroke-width="1" stroke="#aeaeae"></rect>';
    OrgChart.templates.mainCompany.field_0 = '<text data-width="150" data-text-overflow="multiline" style="font-size: 16px;" fill="#757575" x="10" y="150" text-anchor="start">{val}</text>',
    OrgChart.templates.mainCompany.nodeMenuButton = ""
    /*  */

    /* Branch office */
    OrgChart.templates.branch_office = Object.assign({}, OrgChart.templates.ana);
    OrgChart.templates.branch_office.size = [330, 50];
    OrgChart.templates.branch_office.node =
        '<rect x="0" y="0" width="330" height="50" fill="#ffffff" stroke-width="1" stroke="#aeaeae"></rect>';
    OrgChart.templates.branch_office.field_0 = '<text style="font-size: 24px;" fill="#aeaeae" x="165" y="30" text-anchor="middle">{val}</text>';

    OrgChart.templates.branch_office.ripple = {
        radius: 0,
        color: "#F57C00",
        rect: null
    };
