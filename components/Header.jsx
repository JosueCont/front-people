...
const headerCustom = ({hideMenu, ...props}) => {
    ...
    useEffect(() => {
        ...
        Axios.post(API_URL + `/person/person/person_for_khonnectid/`, {id: user.user_id,})
            .then((response) => {
        ...
        <>
            <Global
                styles={css`
                  ...
                  .ant-menu.ant-menu-dark, .ant-menu-dark .ant-menu-sub, .ant-menu.ant-menu-dark .ant-menu-sub:hover {
                    color: white !important;
                  ...
                  .ant-menu-dark.ant-menu-dark:not(.ant-menu-horizontal) .ant-menu-submenu-title:hover {
                    background-color: ${secondaryColor};
                  }
