  ...
  const PasswordRecover = (props) => {
    ...
    const sendEmail = async (email) => {
      try {
        ...
        let response = await Axios.post(LOGIN_URL + "/password/reset/token/", data, { headers: headers });
        ...
        <Spin tip="Loading..." spinning={loading}>
          ...
          >
            { sendSuccess ? 
                ...
                :
                <>
                <Form.Item name="email" rules={[ruleRequired]} label="Correo electrónico" className="font-color-khor">
                <Input
                  style={{ marginTop: "5px" }}
